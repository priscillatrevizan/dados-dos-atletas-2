class Atleta {
    ...
    calculaMediaValida() {
        ...
        let notasAtribuidas = notasOrganizadas.slice(1, 4)

        let somaNotasAtribuidas = notasAtribuidas.reduce(function (total, atual) {
            return total + atual 
        }, 0)

        let media = (somaNotasAtribuidas / notasAtribuidas.length).toFixed(2);
